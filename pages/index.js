...
export default () => (
  <Page>
    ...
    <section>
      <div id="image">
        <Image src="/static/mattmezza-new.jpeg" width={150} isCircle />
      </div>
      <h2>{`Hi. I'm`}</h2>
      <h1>Matteo</h1>
      <div id="what-I-am">
    ...
    <nav>
      ...
      <a href={`tel://+31653707491`}>
        <FA name="phone" />
      </a>
      <a href={`https://telegram.me/mattmezza`}>
        <FA name="telegram" />
      </a>
      <a href={`https://instagram.com/chiamamimatt`}>
        <FA name="instagram" />
      </a>
      ...
      <a href={`mailto:matteo@merola.co`}>
        <FA name="envelope" />
      </a>
      <a href={`https://github.com/mattmezza`}>
        <FA name="github" />
      </a>
      <Link href="/thoughts" prefetch>
        <a>My Thoughts 💭</a>
      </Link>
    </nav>
